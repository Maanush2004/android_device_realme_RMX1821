APPEND_CERTS := $(LOCAL_PATH)/dtbo/append_certs.py
...
$(BOARD_PREBUILT_DTBOIMAGE):
	...
	$(APPEND_CERTS) --alignment 16 --cert1 $(LOCAL_PATH)/dtbo/cert1.der --cert2 $(LOCAL_PATH)/dtbo/cert2.der --dtbo $(BOARD_PREBUILT_DTBOIMAGE)
