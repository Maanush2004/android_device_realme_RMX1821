...
1)
    ...
    # Set CPU Freq
    # big cluster
	echo 1 1014000 > /proc/ppm/policy/hard_userlimit_max_cpu_freq
	echo 1 793000 > /proc/ppm/policy/hard_userlimit_min_cpu_freq
	# LITTLE cluster
	echo 0 1014000 > /proc/ppm/policy/hard_userlimit_max_cpu_freq
	echo 0 793000 > /proc/ppm/policy/hard_userlimit_min_cpu_freq
	
	# Lock Lowest GPU Freq
    echo 300000 > /proc/gpufreq/gpufreq_opp_freq
...
2)
	...
	echo 1 1989000 >/proc/ppm/policy/hard_userlimit_min_cpu_freq
    # LITTLE cluster
	echo 0 1989000 >/proc/ppm/policy/hard_userlimit_max_cpu_freq
	echo 0 1989000 >/proc/ppm/policy/hard_userlimit_min_cpu_freq
